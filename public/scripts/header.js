/*
- This header will be displayed on every page (for the multi-page component) to ensure it is always accessible.
This page should check if the user is logged in and determined what content to display.
*/
$(() => {
  window.header = {};
...
/*
//This is the header of LightBnB for consultation
$(() => {
  window.header = {};
